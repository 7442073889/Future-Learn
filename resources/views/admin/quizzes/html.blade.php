...
<head>
    ...
    <title>HTML Quiz - Future Learn</title>
...
<body class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white">
    ...
    <nav class="glass flex justify-between items-center p-4 mx-4 my-4">
        <h1 class="text-xl font-bold neon-text">🔖 HTML Quiz</h1>
        <div class="mb-6">
    ...
    <div class="container mx-auto p-6">
        <div class="glass p-6 rounded-lg">
            <h2 class="text-2xl font-bold neon-text">Test Your HTML Knowledge</h2>
            <p class="text-gray-300 mt-2">
                Answer the following questions and test your HTML skills.
            </p>
        </div>

        <!-- Quiz Questions -->
        <div class="glass p-6 rounded-lg mt-6">
        <form action="{{ route('admin.quiz.html.submit') }}" method="POST">
    @csrf
    <div class="mb-4">
        <label class="block text-gray-300">1. What does HTML stand for?</label>
        <input type="text" name="q1" class="w-full p-2 mt-2 bg-gray-800 text-white border border-gray-600 rounded">
    </div>

    <div class="mb-4">
        <label class="block text-gray-300">2. Which tag is used to create a hyperlink?</label>
        <select name="q2" class="w-full p-2 mt-2 bg-gray-800 text-white border border-gray-600 rounded">
            <option>&lt;a&gt;</option>
            <option>&lt;link&gt;</option>
            <option>&lt;href&gt;</option>
        </select>
