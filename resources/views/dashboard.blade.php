...
<body class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white" id="theme">
    ...
    <nav class="glass flex justify-between items-center p-4 mx-4 my-4">
        ...
        <div class="relative">
            ...
            <div id="profile-menu" class="absolute right-0 mt-2 w-48 bg-gray-800 text-white rounded shadow-lg hidden">
                ...
                <a href="{{ route('account.logout') }}" class="block px-4 py-2 text-red-400 hover:bg-red-600">Logout</a>
            </div>
        </div>
    </nav>
    ...
    <div class="flex">
        ...
        <aside class="glass w-64 h-screen p-5 mx-4">
            <ul class="space-y-6">
                ...
                <li class="font-semibold text-gray-300 hover:text-purple-400 transition-all">
                    <a href="{{ route('livepractice') }}">📈 Livepractice</a>
                </li>
        ...
        <main class="flex-1 p-8">
            <h2 class="text-3xl font-bold neon-text">
                🚀 Welcome to Your Dashboard {{ Auth::guard('web')->user()->name }}
            </h2>
