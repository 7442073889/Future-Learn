...
<body class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white">
    ...
    <nav class="glass flex justify-between items-center p-4 mx-4 my-4">
        ...
        <div>
            <span class="text-gray-300 font-medium mr-4">Hello, {{ Auth::guard('web')->check() ? Auth::guard('web')->user()->name : 'Guest' }}
</span>
            <a href="{{ route('account.logout') }}" class="bg-red-500 neon-button text-white px-4 py-2 rounded">Logout</a>
        </div>
    </nav>
